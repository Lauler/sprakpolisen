...
Därför har SpråkpolisenBot beslutat att släppa lös en AI-modell på /r/sweden. Modellens syfte är dels fortfarande att rätta förväxlingar av **`de`** och **`dem`**, men att göra det i ett sammanhang där den felande användaren alltid länkas till resurser som låter denne lära sig. Detta sker främst genom att
...
Vid träningen av DeFormer introducerades slumpmässiga substitioner, där `de` eller `dem` byttes ut mot den motsatta formen. Modellen utmanades sedan att klassificera vilka `de/dem` som var korrekta i en given meningen, samt vilka som tillhörde den förvanskade substituerade formen.
